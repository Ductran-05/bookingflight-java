...
public class AirlineService {
    ...
    public ResponseEntity<APIResponse<AirlinePopularityResponse>> getAirlinePopularity() {
        ...
        responseData.setAirline1(
                airlineInfos.size() > 0 ? airlineInfos.get(0) : new AirlinePopularityResponse.AirlineInfo("None", 0.0));
        responseData.setAirline2(
                airlineInfos.size() > 1 ? airlineInfos.get(1) : new AirlinePopularityResponse.AirlineInfo("None", 0.0));
