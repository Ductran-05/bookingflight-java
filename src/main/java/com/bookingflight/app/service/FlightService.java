...
public class FlightService {
    ...
    public FlightResponse createFlight(FlightRequest request) {
        ...
        flightResponse.setIntermediateAirports(flight_AirportRepository.findAllByFlightId(flight.getId())
                .stream()
                .map(flight_Airport -> flight_AirportMapper.toFlight_AirportResponse(flight_Airport, flightRepository,
                        airportRepository))
                .toList());
        flightResponse.setListFlight_SeatResponses(flight_SeatRepository.getAllFlight_SeatByFlightId(flight.getId())
                .stream().map(flight_Seat -> flight_SeatMapper.toFlight_SeatResponse(flight_Seat, flightRepository,
                        seatRepository))
                .toList());
